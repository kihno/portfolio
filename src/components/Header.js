            ...
            <div className="headerSection">
                ...
                <div className="aboutContainer">
                    ...
                    <div className="iconContainer aboutIcons">
                        <a href="https://github.com/kihno" className="icon"><i className="devicon-github-original"></i></a>
                        <a href="https://linkedin.com/in/nicholas-miles-93328227/" className="icon"><i className="devicon-linkedin-plain"></i></a>
                    </div>         
                </div>
            </div>
        </div>
