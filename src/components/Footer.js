        ...
        <div id="footer">
            <div className="contact">
                ...
                <div className="iconContainer">
                    <a href="https://github.com/kihno"><i className="icon devicon-github-original"></i></a>
                    <a href="https://linkedin.com/in/nicholas-miles-93328227/"><i className="icon devicon-linkedin-plain"></i></a>
                </div> 
            </div>
